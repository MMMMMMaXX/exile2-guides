...
> 文档更新时间：2026-08-03 00:40（Asia/Shanghai）
...
> 本节更新时间：2026-08-03 00:40（Asia/Shanghai）
...
| -------------- | ----------------------------------------------- | ---------------------------------------------------------------- | -------- | -------------------------------------- |
| About          | `/en/about/`、`/zh-cn/about/`                   | 只读、独立开发者运营、来源研究与自动 QA、草稿排除、非官方身份     | 通过     | 后续实际流程变动时更新文字             |
