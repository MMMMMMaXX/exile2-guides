...
4. Read the seed (number) and the leader/faction name from the flavour line — these decide the result.
5. For Undying Hate, also count the number of Desecrated modifiers (0-4) — value driver.
6. Confirm the live price on poe.ninja before any large trade (Early Access 0.5.4, PC).
