...
- Desecrated Modifier Build — adds 1-4 Desecrated mods via Preserved Cranium; highest power, Unstable Desecration risk; most stop at 2-3.
- High-budget Min-max — perfect seed + 3-4 Desecrated mods; verify seed, name, socket, AND desecration outcome before committing.

Decision rule: pick the single Historic jewel shape that matches the build's core need (Keystone conversion vs Tribute scaling vs Desecrated mods) before spending currency.
