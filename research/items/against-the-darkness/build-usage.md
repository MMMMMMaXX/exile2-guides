# Build Usage — Against the Darkness
...
- Hybrid attribute + defence — pair attribute Notable with life/mana Small roll.

Decision rule: equip only when the covered allocated nodes beat a Rare jewel in the same socket.
