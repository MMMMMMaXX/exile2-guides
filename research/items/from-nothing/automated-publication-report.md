# Automated Publication Report — From Nothing
...
- Guide/other source count: 2 (GameRant, GamesRecon)
...
- Trade-search description: yes (trade-search data-table + trade-search.md).
