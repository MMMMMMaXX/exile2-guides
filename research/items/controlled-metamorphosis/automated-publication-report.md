# Automated Publication Report — Controlled Metamorphosis
...
- subcategoryId: unique-jewels
- itemClass: jewel / baseType: diamond
- rarity: unique
- requiredLevel: 20 (confirmed by poe2db + poe2dictionary)
...
- Guide/other source count: 1 (GameRant)
...
- Trade-search description: yes (trade-search.md; trade steps in troubleshooting/usage).
- Current vs legacy comparison: yes (overview + current-vs-legacy.md + patch-history; Chaos removal 0.4.0).
...
- Schema validation: passed (20 required sections + 2 data-tables, unique order/id)
- Status = published
- seo.noindex = false
...
- Build decision value: 15/15
- Trade & valuation: 10/10
- Community questions: 10/10
- Media & diagram: 5/5
- Internal links: 5/5
- SEO & publish state: 5/5
