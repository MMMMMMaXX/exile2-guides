# Current Version — Controlled Metamorphosis (0.5.4)
...
- Line: "Passives in Radius can be Allocated without being connected to your tree" + "Only affects Passives in (Very Small-Massive) Ring".
- Applies **-(20-5)% to all Elemental Resistances** (no Chaos line in 0.5.4).
- Always Corrupted: cannot be chanced; a Divine Orb can reroll the Elemental penalty and ring size within range.
