# Megalomaniac — Video Timestamps

## Featured Video

- **Title:** "MEGALOMANIAC: ONE OF THE BEST JEWELS IN POE 2?!"
- **URL:** https://www.youtube.com/watch?v=am-wWkYx0K4
- **Source ID:** `youtube-megalomaniac`
...
Reddit and comment threads (`reddit-megalomaniac`) frequently share Simulacrum farm showcases; no separate canonical URL is required for the article.
