# Current Version — Voices and Sinister Jewel Sockets (0.5.4)
...
- Sinister Sockets are beside the character portrait, not on the passive tree, so radius bonuses never apply.
- Excludes Unique Jewels: only Magic / Rare jewels (and specific compatible types) may be slotted. Unique jewels are rejected.
- Limited to 1.
- Corrupted — no further crafting (cannot be chanced, cannot be annulled/divine-changed).
- Drop: Simulacrum (wave reward).
...
All values above are 0.5.4-current; do not mix with legacy notes in current-vs-legacy.md.
