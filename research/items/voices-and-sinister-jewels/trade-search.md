...
4. Name: Voices
5. Socket variant is shown in the item name/implicits — filter by the allocated socket count you want (2/3/4) if the site supports it; otherwise read each listing.
6. Confirm Corrupted (always) and that it is the current 0.5.x version.
