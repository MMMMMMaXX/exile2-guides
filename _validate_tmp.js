...
const fs = require("fs");
const p =
  "/Users/manxin/Downloads/exile2-guides-prd/content/ja/patches/patch-0-3-0-support-gem-overhaul.json";
...
console.log(
  "root has contentId/sourceContentId/sourceRevision:",
  "contentId" in data || "sourceContentId" in data || "sourceRevision" in data,
);
console.log("status:", data.status, "seo.noindex:", data.seo.noindex);
const bad = ["completed", "manual-review", "none"].filter((k) =>
