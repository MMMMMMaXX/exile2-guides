...
const fs = require('fs');
const p = '/Users/manxin/Downloads/exile2-guides-prd/content/de/items/catalysts.json';
...
const forbidden = ['contentId','sourceContentId','completed','manual-review','none'];
