...
const fixes: Array<[string, string, string]> = [
  [
    ...
    '"itemCategory": "waystones-guide"',
    '"itemCategory": "waystones"',
  ],
  [
  ...
  [
    ...
    '"itemCategory": "uncut-gems-guide"',
    '"itemCategory": "uncut-gems"',
  ],
  [
  ...
  [
    "content/en/items/tablets.json",
    '"itemCategory": "waystones-guide"',
    '"itemCategory": "waystones"',
  ],
  [
    "content/zh-cn/items/tablets.json",
    '"itemCategory": "waystones-guide"',
    '"itemCategory": "waystones"',
  ],
];
