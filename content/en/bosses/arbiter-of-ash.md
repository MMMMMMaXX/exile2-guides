...
tags: [boss, arbiter-of-ash, endgame, verification]
...
1. Capture the current encounter name, entry path, and character context.
2. Record each phase transition only when it is observed, including the visible trigger and recovery result.
3. Describe attacks by their telegraph and observed outcome until official or in-game naming is confirmed.
